...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    <p style="background: #fef3c7; border: 1px solid #f59e0b; padding: 12px; border-radius: 4px; font-size: 13px;">
        <strong>If you are not the owner of {{ config('app.name', 'Klog') }}, please forward this message to them.</strong><br>
        A recipient for error messages can be specified in <code>.env</code>, please see the readme for more info.
    </p>
